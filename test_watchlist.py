...
from watchlist_app.commands import forge, initdb
...
class WatchlistTestCase(unittest.TestCase):
    ...
    def test_login_protect(self):
        ...
        self.assertNotIn('<form method="post" action="/index">', data)
    ...
    def test_login(self):
        ...
        self.assertIn('<form method="post" action="/index">', data)
    ...
    def test_create_item(self):
        ...
        response = self.client.post("/", data=dict(title="", year="fake"), follow_redirects=True)
        data = response.get_data(as_text=True)
        self.assertNotIn("search_text=fake", data)

        response = self.client.post("/", data=dict(title="fake", year=""), follow_redirects=True)
        data = response.get_data(as_text=True)
        self.assertNotIn("search_text=fake", data)
    ...
    def test_user_page(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn("Hello John", data)
        self.assertIn("totoro.gif", data)
